...
pub static TEXT_EXT: [&str; 12] = [
  "md", "txt", "doc", "docx", "pptx", "odf", "docm", "pdf", "csv", "rtf",
  "epub", "mobi",
];
pub static IMAGE_EXT: [&str; 11] = [
  "jpg", "png", "jpeg", "gif", "tiff", "psd", "bmp", "ico", "svg", "webp",
  "heic",
];
pub static AUDIO_EXT: [&str; 6] = ["mp3", "wma", "wav", "flac", "m4a", "ogg"];
pub static VIDEO_EXT: [&str; 7] =
  ["mov", "mp4", "avi", "mkv", "flv", "wmv", "webm"];
